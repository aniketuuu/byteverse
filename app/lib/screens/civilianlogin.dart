...
class Civilianlogin extends StatefulWidget {
  const Civilianlogin({super.key});

  @override
  State<Civilianlogin> createState() => _CivilianloginState();
}

class _CivilianloginState extends State<Civilianlogin> {
  @override
